...
@Component({
  selector: 'aeliusmd-view-macro-field',
  templateUrl: './view-macro-field.component.html',
  styleUrls: [
    './view-macro-field.component.css',
    './view-macro-field.component.scss',
  ],
})

export class ViewMacroFieldComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._form = this.formBuilder.group({
      ...
      recordStatusId: [{ value: null, disabled: true }, [Validators.required]],
  ...
  close() {
    if (this._form.dirty == true) {
      this.confirmationService.confirm({
        key: 'createMacroFieldsConfirmDialog',
        message:
  ...
  onRetrieved(data: any) {
    ...
    console.log('ffdgdgdg',this._macroField)
  }
