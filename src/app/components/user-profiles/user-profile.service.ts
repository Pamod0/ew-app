...
export class UserProfileService {
  ...
  getUserProfilesByClientDropDown(clientId: number): Observable<IUserProfile[]> {
    return this.http.get(this._apiUrl + '/GetUserProfilesByClientDropDown/' + clientId).pipe(
      map((response: any) => {
        return response.data;
      })
    );
