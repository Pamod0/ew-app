...
@Component({
  selector: 'app-register-partner-organization',
  templateUrl: './register-partner-organization.component.html',
  styleUrl: './register-partner-organization.component.scss',
  encapsulation: ViewEncapsulation.None
})
export class RegisterPartnerOrganizationComponent implements OnInit, AfterViewInit {
  _innerHeight: number;
  registerForm: FormGroup;

  userTypes: any[] = [
      { name: 'Government', key: 'A' },
      { name: 'Private', key: 'M' }
  ];
