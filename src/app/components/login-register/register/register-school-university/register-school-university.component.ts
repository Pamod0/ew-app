...
@Component({
  selector: 'app-register-school-university',
  templateUrl: './register-school-university.component.html',
  styleUrl: './register-school-university.component.scss',
  encapsulation: ViewEncapsulation.None
})
export class RegisterSchoolUniversityComponent implements OnInit, AfterViewInit {
  _innerHeight: number;
  registerForm: FormGroup;

  userTypes: any[] = [
      { name: 'School', key: 'A' },
      { name: 'University', key: 'M' }
  ];
